                    ...
                    <article className="rounded-lg border bg-card p-5 text-card-foreground">
                        <div className="flex items-start justify-between gap-4">
                            <div>
                                ...
                                <h3 className="mt-1 text-xl font-semibold tracking-tight">Burn Camp</h3>
                                <p className="mt-2 max-w-lg text-sm text-muted-foreground">
                                    Track calories burned and exercise minutes while competing with friends for leaderboard spots.
                                </p>
